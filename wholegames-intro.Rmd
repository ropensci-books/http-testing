...
In the following chapters, we'll add more robust testing infrastructure to this minimal package, and we will do that _three_ times to compare packages/approaches: once with [vcr](#vcr), once with [httptest](#httptest), and once with [presser](#presser).
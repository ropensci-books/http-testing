...
* When then create a local app process via `presser::local_app_process()`. It will be started automatically when we call the `$url()` method to know where it's served at; and most importantly it will be stopped automatically after the test. No mess made!

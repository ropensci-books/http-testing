...
* We enable the use of `{webmockr}` at the beginning with `webmockr::enable()`. Why webmockr? Because it's the package powering request stubbing in vcr so vcr and webmockr go well together.

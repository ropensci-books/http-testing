...
* Always having one continuous integration build with vcr turned off;
...
We also added a continuous integration workflow for having a build using real interactions once every week.

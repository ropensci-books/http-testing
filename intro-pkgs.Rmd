...
Therefore, with `{presser}` there is faking but what's faked is the web service itself.
...
[^limits]:  If you end up using crul, you can use vcr and webmockr; or presser; but not httptest. If you end up using curl you can only use presser.
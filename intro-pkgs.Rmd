...
Contrary to `{vcr}`, `{httptest}` also lets you define mock files by hand (copying from API docs, or dumbing down real responses), whereas with vcr all mock files come from recording real interactions.
...
It will let you faking a whole web service, potentially outputting responses from mock files you'll have created.
...
::: {.alert .alert-dismissible .alert-info} 
[Direct link to presser demo](#presser)
:::

...
* or you edit a cassette by hand which would be similar to testing for API errors with httptest. If you did that, you'd need to skip the test when [vcr is off](https://docs.ropensci.org/vcr/reference/lightswitch.html), as when vcr is off real requests are made.

...
The key function will be `httptest::with_mocked_dir("dir", {<code-block>})` which tells vcr to create mock files under `tests/testthat/dir` to store all API responses for API calls occurring in the code block. 

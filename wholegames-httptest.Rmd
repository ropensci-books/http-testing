...
Note that the `httptest::with_mockr_dir()` function is only available in httptest version >= 3.3.0.9000, not released on CRAN at the time of writing, so you'll have to install httptest from GitHub via `remotes::install_github("nealrichardson/httptest")`.
:::

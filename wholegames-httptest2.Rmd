...
Regarding our secret API token, since httptest2 doesn't save the requests, and since the responses don't contain the token, it is safe without our making any effort.
...
One could use the same strategy as the one [we exemplified for httptest](#httptest2-real) i.e. with a different test folder.

...
Are you working on a R package accessing resources on the web, be it a cats API, a scientific data source or your CRM system[^crm]?
...
None of crul, webmockr, vcr, httptest, presser have compiled code, but an underlying dependency of all of them, `curl` does. See [curl's README](https://github.com/jeroen/curl/#installation) for installation instructions in case you run into curl related problems. presser has compiled code.
